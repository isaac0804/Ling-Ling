...
checkpoints = torch.load("checkpoints/model_epoch-16.pt")
...
high_emb = high_cb[torch.randint(0, 32, size=(1, 16))]
mid_emb = mid_cb[torch.randint(0, 64, size=(1, 64))]
low_emb = low_cb[torch.randint(0, 128, size=(1, 256))]
